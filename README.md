...
1. [01_count_relationships](arangodb/queries_eurovoc/01_count_relationships.aql)
```
RETURN LENGTH(prefLabel)
```

1. [02_count_context_nodes](arangodb/queries_eurovoc/02_count_context_nodes.aql)
```
...
1. [03_substring_check_simple](arangodb/queries_eurovoc/03_substring_check_simple.aql)
```
FOR l in label
  FILTER l.lang == "en"
...
1. [04_substring_check_complex](arangodb/queries_eurovoc/04_substring_check_complex.aql)
```
FOR l1 in label
  FILTER l1.lang == "en"
  FOR l2 in label
...
1. [05b_labels_equivalence](arangodb/queries_eurovoc/05b_labels_equivalence.aql)
```
...
1. [05_labels_equivalence](arangodb/queries_eurovoc/05_labels_equivalence.aql)
```
...
1. [07_get_sorted_labels](arangodb/queries_eurovoc/07_get_sorted_labels.aql)
```
FOR l in label
  FILTER l.lang == "en"
  FOR v, e in INBOUND l._id
...
1. [08_shortest_path](arangodb/queries_eurovoc/08_shortest_path.aql)
```
